    ...
    const fetchIncidents = React.useCallback(async () => {
      try {
        ...
        const userIncidents = response.data.filter(
          (incident) => incident.userId === currentUser.userInfo.id
        );
        ...
        <div className="container">
          <div className="content">
            ...
            <div className="profile-summary">
              ...
              <span className="name">{currentUser.userInfo.fname}</span>
              <span className="name">{currentUser.userInfo.lname}</span>
        ...
        <div className="tab-content scrollbar">
          {activeTab === 'profile' && (
            <div className="profile text">
              ...
              <div className="profileImage">
                <img
                  src={currentUser.userInfo.avatar || 'no-avatar.png'}
                  alt="profile-pic"
                />
              </div>
              <div className="profileInfo">
                ...
                <div className="detail-info">
                  <div className="detail">
                    {currentUser.userInfo.fname + ' ' + currentUser.userInfo.lname}
                  </div>
                  <div className="detail">{currentUser.userInfo.email}</div>
                  <div className="detail">{currentUser.userInfo.mobile}</div>
                </div>
              </div>
