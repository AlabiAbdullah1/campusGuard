    ...
    <div className="incidentPage">
      <div className="top">
        <div className="details">
          ...
          <Slider images={incident.images && incident.images.length > 0 ? incident.images : ['/no-image.png']} />
            <div className="info">
              <div className="top">
                  ...
                  <div className="userInfo">
                    <div>
                      ...
                      <img
                        ...
                        alt="user"
                      />
                      <span>{incident.user.fname + " " + incident.user.lname || '-'}</span>
                    </div>
                  </div>
                )}
              </div>
      ...
      <Dialog open={emailPopupOpen} onClose={handleCloseEmailPopup}>
        ...
        <DialogContent>
          Are you sure you want to send emails to all users?
        </DialogContent>
