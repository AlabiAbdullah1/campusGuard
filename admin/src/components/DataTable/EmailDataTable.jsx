...
export const EmailDataTable = () => {
  ...
  const formatDate = (dateString) => {
    ...
    return date.toLocaleDateString('en-US', { timeZone: 'Africa/Lagos' });
  };
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // console.log(allEmails[0].sentBy.username)
        setData(allEmails);
  ...
  const columns = [
    ...
    { field: 'location', headerName: 'location', flex: 2/31, minWidth: 120 },
        ...
        <DialogContent>
          {selectedEmail && (
            <div className="viewBox">
              ...
              <p>
                <strong>location:</strong> {selectedEmail.location}
              </p>
              <p>
                <strong>Sent to:</strong> {selectedEmail.userCount}
              </p>
              <p>
                <strong>Sent by:</strong> {selectedEmail.sentBy.username}
              </p>
              <p>
